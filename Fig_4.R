...
write.csv(mer_hrze, paste(tab_folder,paste("rnaseq_volcano_plot_berry_hrze",".csv",sep=""),sep = "/"))
...
write.csv(mer_ntz, paste(tab_folder,paste("rnaseq_volcano_plot_berry_ntz",".csv",sep=""),sep = "/"))
...
write.csv(mer_hrze, paste(tab_folder,paste("rnaseq_volcano_plot_ibd_hrze",".csv",sep=""),sep = "/"))
...
write.csv(mer_ntz, paste(tab_folder,paste("rnaseq_volcano_plot_ibd_ntz",".csv",sep=""),sep = "/"))
