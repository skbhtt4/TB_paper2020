...
phy_pair <- readRDS("../data/Long_Obs/phy_rna_tb.rds")
...
pdf(paste0(fig_folder,"/Mean_Dispersion_plot_Long_Obs.pdf"),width = 5,height = 5)
...
write.csv(sum_dt ,paste(tab_folder,paste("Summary_Long_Obs_Time_comp_genes.csv",sep=""),sep = "/"))
...
berry_data <- read.csv("../data/Berry/HRZE_NTZ_Berry_List_April_2020.csv")
ibd_data <- read.csv("../data/IBD/IBD_sig_genes.csv")
...
pdf(paste(fig_folder,"rnaseq_volcano_plot_berry_hrze_Long_Obs_Day_14_Day_0.pdf",sep = "/"),height = 5, width = 6)
print(hrze_berryp)
dev.off()


write.csv(fc_dt, paste(tab_folder,paste("rnaseq_volcano_plot_berry_hrze_Day_14_Day_0",".csv",sep=""),sep = "/"))
...
berry_hrze_sig <- berry_hrze[berry_hrze$global_padj < 0.05,] 
berry_hrze_sig
write.csv(berry_hrze_sig, paste(tab_folder,paste("Long_Obs_Berry_HRZE_differential_Day_14_Day_0",".csv",sep=""),sep = "/"))
...
pdf(paste(fig_folder,"rnaseq_volcano_plot_ibd_hrze_Long_Obs_Day_14_Day_0.pdf",sep = "/"),height = 5, width = 6)
print(hrze_ibdp)
dev.off()

write.csv(fc_dt, paste(tab_folder,paste("rnaseq_volcano_plot_ibd_hrze_Day_14_Day_0",".csv",sep=""),sep = "/"))
...
ibd_hrze_sig <- ibd_hrze[ibd_hrze$global_padj < 0.05,] 
nrow(ibd_hrze_sig)
write.csv(ibd_hrze_sig, paste(tab_folder,paste("Long_Obs_IBD_HRZE_differential_Day_14_Day_0",".csv",sep=""),sep = "/"))
...
pdf(paste(fig_folder,"rnaseq_volcano_plot_berry_hrze_Long_Obs_Day_56_Day_0.pdf",sep = "/"),height = 5, width = 6)
print(hrze_berryp)
dev.off()

write.csv(fc_dt, paste(tab_folder,paste("rnaseq_volcano_plot_berry_hrze_Long_Obs_Day_56_Day_0",".csv",sep=""),sep = "/"))
...
berry_hrze_sig <- berry_hrze[berry_hrze$global_padj < 0.05,] 
berry_hrze_sig
write.csv(berry_hrze_sig, paste(tab_folder,paste("Long_Obs_Berry_HRZE_differential_Day_56_Day_0",".csv",sep=""),sep = "/"))
...
pdf(paste(fig_folder,"rnaseq_volcano_plot_ibd_hrze_Long_Obs_Day_56_Day_0.pdf",sep = "/"),height = 5, width = 6)
print(hrze_ibdp)
dev.off()

write.csv(fc_dt, paste(tab_folder,paste("rnaseq_volcano_plot_ibd_hrze_Long_Obs_Day_56_Day_0",".csv",sep=""),sep = "/"))
...
ibd_hrze_sig <- ibd_hrze[ibd_hrze$global_padj < 0.05,] 
nrow(ibd_hrze_sig)
write.csv(ibd_hrze_sig, paste(tab_folder,paste("Long_Obs_IBD_HRZE_differential_Day_56_Day_0",".csv",sep=""),sep = "/"))
...
pdf(paste(fig_folder,"rnaseq_volcano_plot_berry_hrze_Long_Obs_Day_56_Day_14.pdf",sep = "/"),height = 5, width = 6)
print(hrze_berryp)
dev.off()


write.csv(fc_dt, paste(tab_folder,paste("rnaseq_volcano_plot_berry_hrze_Long_Obs_Day_56_Day_14",".csv",sep=""),sep = "/"))
...
berry_hrze_sig <- berry_hrze[berry_hrze$global_padj < 0.05,] 
berry_hrze_sig
write.csv(berry_hrze_sig, paste(tab_folder,paste("Long_Obs_Berry_HRZE_differential_Day_56_Day_14",".csv",sep=""),sep = "/"))
...
pdf(paste(fig_folder,"rnaseq_volcano_plot_ibd_hrze_Long_Obs_Day_56_Day_14.pdf",sep = "/"),height = 5, width = 6)
print(hrze_ibdp)
dev.off()

write.csv(fc_dt, paste(tab_folder,paste("rnaseq_volcano_plot_ibd_hrze_Long_Obs_Day_56_Day_14",".csv",sep=""),sep = "/"))
...
ibd_hrze_sig <- ibd_hrze[ibd_hrze$global_padj < 0.05,] 
nrow(ibd_hrze_sig)
write.csv(ibd_hrze_sig, paste(tab_folder,paste("Long_Obs_IBD_HRZE_differential_Day_56_Day_14",".csv",sep=""),sep = "/"))
